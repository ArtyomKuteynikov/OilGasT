...
def create_tags(spec):
    ...
    """
    tags = [
        {'name': 'auth', 'description': 'Авторизация и все действия с базой юзеров'},
        {'name': 'account', 'description': 'Данные аккаунта(qr, карта лояльности, уведомления)'},
        {'name': 'offers', 'description': 'Акции'},
        {'name': 'cars', 'description': 'Машины'},
        {'name': 'wallet', 'description': 'Финансы(баллы, литры, депозиты)'},
    ]
